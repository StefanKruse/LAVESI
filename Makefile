...
clean:
	@rm -rf data*.csv nohup.out output/parameterchoice.csv output/data*.csv t_*.txt pollDist* output/windgen*.txt output/*.png output/*.mp4 output/firegap/*_firegap.csv output/firegap/firegap_*.txt output/*.gif t_*.txt build LAVESI_WIND
