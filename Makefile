...
CFLAGS= -c -O0 -g3 -ggdb3 -std=c++0x -Wno-parentheses -Wall --pedantic -include ./inc/libraries.h -include ./inc/structures.h -include ./inc/declarations.h -include ./inc/funktionen.h
#CFLAGS2= -c -O0 -g3 -ggdb3 -std=c++0x -Wno-parentheses -Wall
