...
// Spezielle Funktionen
 ...
 void seedausbreitung(int Jahr,int yrpos, struct Parameter *parameter, vector<list<seed*> > &world_seed_list);
 ...
 void influx( struct Parameter *parameter, int year, vector<list<Tree*> > &world_tree_list);
