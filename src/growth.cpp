    ...
    if (parameter[0].n_weather_along_grid>0) {
        ...
        if (parameter[0].thawing_depth) {
            if (tree.species == 1) {
                maxbw_help =
                    ...
                    * weighmeanweathervar(weather_list[yearposition].weatherfactorg, ((double)tree.ycoo/1000)-transectstart)
                ...
                maxbw_help =
                    ...
                    * weighmeanweathervar(weather_list[yearposition].weatherfactors, ((double)tree.ycoo/1000)-transectstart)
            ...
            if (tree.species == 1) {
                maxbw_help =
                    ...
                    * (weather_list[yearposition].weatherfactorg[0]
                       + ((weather_list[yearposition].weatherfactorming[0] - weather_list[yearposition].weatherfactorg[0]) * ((double)tree.ycoo / 1000)
                          / ((double)treerows)))
                    * (((double)tree.thawing_depthinfluence) / 100);
            } else if (tree.species == 2) {
                maxbw_help =
                    ...
                    * (weather_list[yearposition].weatherfactors[0]
                       + ((weather_list[yearposition].weatherfactormins[0] - weather_list[yearposition].weatherfactors[0]) * ((double)tree.ycoo / 1000)
                          / ((double)treerows)))
                    * ((((double)tree.thawing_depthinfluence * 0.8) / 100) - 0.6);
            }
        } else {
        ...
        if (parameter[0].thawing_depth) {
            if (tree.species == 1) {
                maxbw_help =
                    exp(parameter[0].gdbasalconstgmel + parameter[0].gdbasalfacgmel * tree.dbasal + parameter[0].gdbasalfacqgmel * tree.dbasal * tree.dbasal)
                    * ((weather_list[yearposition].weatherfactorg[0] * (((double)tree.elevation / 10) - (parameter[0].elevationoffset + 1000))
                ...
                maxbw_help =
                    exp(parameter[0].gdbasalconstsib + parameter[0].gdbasalfacsib * tree.dbasal + parameter[0].gdbasalfacqsib * tree.dbasal * tree.dbasal)
                    * ((weather_list[yearposition].weatherfactors[0] * (((double)tree.elevation / 10) - (parameter[0].elevationoffset + 1000))
                        / (parameter[0].elevationoffset - (parameter[0].elevationoffset + 1000)))
        ...
        if (parameter[0].thawing_depth) {
            if (tree.species == 1) {
                maxbw_help =
                    exp(parameter[0].gdbasalconstgmel + parameter[0].gdbasalfacgmel * tree.dbasal + parameter[0].gdbasalfacqgmel * tree.dbasal * tree.dbasal)
                    * weather_list[yearposition].weatherfactorg[0] * (((double)tree.thawing_depthinfluence) / 100);
            } else if (tree.species == 2) {
                maxbw_help =
                    exp(parameter[0].gdbasalconstsib + parameter[0].gdbasalfacsib * tree.dbasal + parameter[0].gdbasalfacqsib * tree.dbasal * tree.dbasal)
                    * weather_list[yearposition].weatherfactors[0] * ((((double)tree.thawing_depthinfluence * 0.8) / 100) - 0.6);
            }
        } else {
            if (tree.species == 1) {
                maxbw_help =
