...
void Parametereinlesen(void)
{
	...
	parameter[0].outputmode=(int) (Parametereingabe(&uebergabestring[0], wortlaengemax, &trennzeichen[0], &parameter[0]));
			if (parameter[0].parameterinputvis ==true) 
            {
	...
	parameter[0].computationtimevis=(bool) Parametereingabe(&uebergabestring[0],wortlaengemax, &trennzeichen[0], &parameter[0]);
